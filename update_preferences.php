...
$car_results = mysqli_query($users_con, $q = "select name, email, p.carpool_times_morning as t1, p.carpool_times_evening as t2 from users u join preferences p on u.id = p.user_id where u.zip = $userzip and u.id <> $userid");
