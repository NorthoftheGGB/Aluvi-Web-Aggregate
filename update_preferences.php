...
$car_results = mysqli_query($users_con, $q = "select name, email, p.carpool_times_morning as t1, p.carpool_times_evening as t2 from users u join preferences p on u.id = user_id where zip = $userzip and id <> $userid");
